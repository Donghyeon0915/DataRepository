# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/16.svg" class="solvedac-tier"> [문자열 제곱](https://www.acmicpc.net/problem/4354) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|53211711|dongdong99|맞았습니다!!|307860KB|624ms|Kotlin (JVM)|786B|
